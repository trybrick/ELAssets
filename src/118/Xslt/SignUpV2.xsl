...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
					...
					<xsl:when test="$IsOGS = 'True'">
						<img>
							<xsl:attribute name="src">
								<xsl:value-of select="concat('/Assets/Common/Images/Registration/pReg_OGS_', Name, '.png')"/>
							</xsl:attribute>
						</img>
					</xsl:when>
					<xsl:otherwise>
						<img>
							<xsl:attribute name="src">
								<xsl:value-of select="concat('/Assets/Common/Images/Registration/pReg_', Name, '.png')"/>
							</xsl:attribute>
						</img>
					</xsl:otherwise>
				</xsl:choose>
	...
	<xsl:template name="otherRequiredInformation">
		...
		<div id="lower">
			...
			<div id="navigation">
				<div class="cancelButton" onclick="parent.location='/'">Cancel</div>
				<div class="nextButton" onclick="javascript:displayNextStep();">Next</div>
			</div>
			<div id="privacy">
				<p class="signUpSml">
	...
	<xsl:template name="otherOptionalInformation">
		...
		<div id="navigation">
			<div class="backButton" onclick="javascript:displayPreviousStep();">Back</div>
			<div class="nextButton" onclick="javascript:displayNextStep();">Next</div>
		</div>
	</xsl:template>
	...
	<xsl:template name="confirmdietarypreferences">
		<div>
			...
			<div id="navigation">
				<div class="yesButton" onclick="javascript:displayNextStep();">Yes</div>
				<div class="nothanksButton" onclick="javascript:saveSignUp();">No, Thanks</div>
			</div>
		</div>
	</xsl:template>
	...
	<xsl:template name="dietarypreferencesdisplay">
		...
		<div id="navigation5">
			<div class="backButton" onclick="javascript:displayPreviousStep();">Back</div>
			<div class="finishButton" onclick="javascript:saveSignUp();">Finish</div>
		</div>
		<hr/>
