...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<div id="SplashBlocks">
			...
			<div id="LargeButton">
				<a>
					<xsl:attribute name="href">/party-trays.aspx</xsl:attribute>
					<img alt="">
						<xsl:attribute name="src">/Assets/##chainid##/Images/catering_button.png</xsl:attribute>
					</img>
				</a>
			</div>
			<div id="DualContentControlDiv">
				<div id="DualContentControlDivA">
					<a href="/Recipes/RecipeVideos.aspx">
						<img alt="">
							<xsl:attribute name="src">/Assets/##chainid##/Images/cooking_video_button.gif</xsl:attribute>
						</img>
					</a>
				</div>
				<br/>
				<div id="DualContentControlDivB">
					<a href="/club-card.aspx">
						<img alt="">
							<xsl:attribute name="src">/Assets/##chainid##/Images/Clubcard_button.png</xsl:attribute>
						</img>
					</a>
				</div>
			</div>
