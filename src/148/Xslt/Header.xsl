...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/"><style type="text/css">
			@import url(http://trigs.gsngrocers.com/Production/trigs-overrides.css);
		</style>
		<!--Import your own CSS file hosted on FTP-->
		
		<div id="header">
			<a id="logo" href="http://www.trigs.com">
				<img src="http://trigs.gsngrocers.com/Production/images/logo.png" alt="Trigs : Fresh for you is what we do!"/>
			</a>
			<div id="location">
				<xsl:choose>
