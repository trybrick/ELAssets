						...
						<xsl:choose>
							<xsl:when test="//GenericConsumer/IsLoggedIn = 'true'">
								...
								<div id="LoginProfileLinkDiv">
									<a id="A2" runat="server" href="http://www.mycountrymart.com/ssl/authenticate/profile.aspx">My Preferences</a>|
									<a id="A3" runat="server" href="http://www.mycountrymart.com/ssl/authenticate/logout.aspx">Log Out</a>
								</div>
							</xsl:when>
							<xsl:otherwise>
								<br/>
								<a id="A4" href="http://www.mycountrymart.com/ssl/authenticate/login.aspx" runat="server">Login</a>| <a id="A4" href="http://www.mycountrymart.com/ssl/authenticate/register.aspx" runat="server">Register</a>
							</xsl:otherwise>
						</xsl:choose>
					</div>
				</div>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\Village Market-Header.xml" htmlbaseurl="" outputurl="" processortype="internal" useresolver="no" profilemode="0" profiledepth="" profilelength=""
