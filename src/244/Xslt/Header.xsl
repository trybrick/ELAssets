		...
		<div id="StoreHeader">
			<div id="StoreHeaderLogo">
				<a href="{//GenericChain/PreferedHost}">
					<!--<img src="/Assets/244/Images/Logo.png" alt="Logo" />-->
				</a>
			</div>
            <!--<div id="StoreInfoDiv">
            	1234 Whatever Street, SomeCity, SomeState  54321 | 555-555-5555 | 24 Hours a Day
            </div>-->
						...
						<div class="inner-wrap group">
							<xsl:choose>
                                ...
                                <xsl:when test="(ExpressLane/FacebookSettings/IsActive = 'true') and (ExpressLane/GenericConsumer/IsLoggedIn != 'true')">
                                    ...
                                    <a class="non-member" href="/Profile/SignUp.aspx" runat="server"></a>
			...
			<xsl:choose>
				<xsl:when test="//GenericConsumer/PrimaryStoreID &gt; 0">
					...
					<div id="StoreHeaderMiddle">
                        <!--<div id="StoreInfoDiv">
                            133 Hwy W Manitowish Waters, Wisconsin 54545 | 715-543-8422 | 24 Hours a Day
                        </div>-->
