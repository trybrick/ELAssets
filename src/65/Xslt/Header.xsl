				...
				<xsl:when test="//GenericConsumer/PrimaryStoreID &gt; 0">
					...
					<div id="StoreHeaderMiddle">
						<div id="StoreInfoDiv" class="StoreInfoDiv">
							...
							<div class="StoreHours">Store Hours: 7:00 AM To 10:00 PM Every Day</div>
						</div>
					</div>
				</xsl:when>
				<xsl:otherwise>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\XmlData\65-PageTypeId-3-Header.xml" htmlbaseurl="" outputurl="" processortype="msxml6" useresolver="no" profilemode="0" profiledepth="" profilelength=""
