					...
					<table width="720" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <table width="350" border="0" align="left" cellpadding="0" cellspacing="0">
						...
						<tr>
						  ...
						  <td valign="top">
							<img src="http://upload.gsngrocers.com/elvs/VirtualStore/Content/custom/themes/##chainid##/logo.png" height="75" style="display:block; height: 75px; width: 85px;"  border="0"/>
						  </td>
						  </tr>
						<tr>
						  <td>
				...
				<table width="710" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td width="28%" rowspan="2" scope="col">
						<img src="http://email.gsngrocers.com/Common/Featured_Items_Tag.jpg" width="207" height="71" align="right" style="display:block;"  border="0"/>
					</td>
				  ...
				  <tr>
					<td valign="bottom">
						<img src="http://email.gsngrocers.com/Common/Featured_topr.jpg" width="520" height="16" align="left" style="display:block;"  border="0"/>
					</td>
				  </tr>
				</table></td>
			  </tr>
				...
				<table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					<td width="3%" rowspan="2" scope="col">
						<img src="http://email.gsngrocers.com/Common/Featured_L.jpg" width="19" height="154" style="display:block;"  border="0"/></td>
					<td width="94%" height="138" scope="col">
						<xsl:call-template name="ExactTargetRetrieve_PersonalizedContent"/>   
					</td>
					<td width="3%" rowspan="2" scope="col"><img src="http://email.gsngrocers.com/Common/Featured_r.jpg" width="23" height="154" style="display:block;"  border="0"/></td>
				  </tr>
				  <tr>
					<td valign="bottom" scope="col"><img src="http://email.gsngrocers.com/Common/featured_bottom_17.jpg" width="685" height="10" align="bottom" style="display:block;"  border="0"/></td>
				  </tr>
				</table>
