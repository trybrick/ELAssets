...
(function(window, undefined) {
	...
	var GSNDomainName = 'ucook.com';
	var webServiceKey = null;
	var shopperWelcomeSetBrand = null;
	...
	gsnShopperWelcome.init = function(options) {
		
		webServiceKey = options.chainId;
		GSNDomainName = options.GSNDomainName || GSNDomainName;
		shopperWelcomeSetBrand = options.shopperWelcomeSetBrand || shopperWelcomeSetBrand;
	...
	gsnShopperWelcome.CallServer = function() {
		...
		if (typeof (GSNDomainName) != 'undefined') {
			request = 'http://' + GSNDomainName + '/WebService/ShopperWelcome/Popup.asmx/ThirdPartyShopperWelcomePopup?url=http://' + location.hostname + '&webServiceKey=' + webServiceKey + '';
		}
