...
function AutoSuggest(elem, suggestions)
{
	...
	********************************************************/
	elem.onkeyup = function(ev) 
	{
		...
		default:
			...
			if (text != me.inputText && text.length > 0)
			{
				me.inputText = text;
				me.getEligible();
				me.createDiv();
				...
				return;
			} else if(text == me.inputText && text.length == 1){
				me.inputText = text;
				me.getEligible();
				me.createDiv();
				me.positionDiv();
	...
	********************************************************/
	...
	this.populateSuggestion = function(){
		if(this.highlighted > -1){
			this.elem.value = this.eligible[this.highlighted];
	...
	********************************************************/
	this.showDiv = function()
	{
		if(this.highlighted > 0){
			if(this.elem.value == this.eligible[this.highlighted]){
				hideDiv();
			}
			else{
	...
	********************************************************/
	this.getEligible = function()
	{
		...
		for (i = 0; i < this.suggestions.length; i++) 
		{
			...
			var suggestion = this.suggestions[i].toString();
			suggestion = suggestion.toLowerCase();
			
			var text = $F(this.elem.id);
			text = text.toLowerCase();
			
			if(suggestion.startsWith('function (')){
				continue;
			}
