		...
		<table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="3%" rowspan="2" scope="col">
					<img src="http://upload.gsngrocers.com/elvs/Common/Featured_L.jpg" width="19" height="154" style="display:block;" border="0"/>
				</td>
				...
				<td width="3%" rowspan="2" scope="col">
					<img src="http://upload.gsngrocers.com/elvs/Common/Featured_r.jpg" width="23" height="154" style="display:block;" border="0"/>
				</td>
			</tr>
			<tr>
				<td valign="bottom" scope="col">
					<img src="http://upload.gsngrocers.com/elvs/Common/featured_bottom_17.jpg" width="685" height="10" align="bottom" style="display:block;" border="0"/>
				</td>
			</tr>
		</table>
	</xsl:template>
