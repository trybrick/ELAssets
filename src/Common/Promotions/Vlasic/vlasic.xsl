...
<!--========================================================================================== -->
	...
	<xsl:template match="/">
		...
		<div id="{//WrapID}">
			...
			<div id="vlasic-footer">
				<p> &#169; 2011 Pinnacle Foods Group LLC</p>
			</div>
...
<!--========================================================================================== -->
	...
	<xsl:template name="ProductRow">
		...
		<div id="{concat('row-',$Row)}">
			<xsl:attribute name="class">vlasic-product-row group<xsl:choose>
...
<!--========================================================================================== -->
	...
	<xsl:template name="ProductDetail" match="Product">
		...
		<div>
			...
			<a class="vlasic-button" title="Add Item to List" src="#null">
