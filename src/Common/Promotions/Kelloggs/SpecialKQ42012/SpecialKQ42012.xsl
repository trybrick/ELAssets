...
<!--========================================================================================== -->
	...
	<xsl:template match="/">		
		...
		<style>
			#promoLP-subhead {background-image: url(http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/Kelloggs/specialkq42012/Images/kelloggs_subhead.jpg); height: 65px; width: 100%;}
			#promoLP-subhead img {float: right; margin: 10px 20px 0 0;}
			#promoLP-main {background-image: url(http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/Kelloggs/specialkq42012/Images/kelloggs_body.jpg); float:left; height: 630px; width: 100%;}
			.promoLP-product {float:left;width:575px;}
			#promoLP-product-wrap1 {margin:5px 0 0 15px;}
			#promoLP-product-wrap2 {margin:5px 0 0 20px;}
			#promoLP-product-wrap3 {margin:5px 0 0 20px;}
			.promoLP-product-listing {float:left; width:180px; text-align: center;}
			#promoLP-product-wrap3 .promoLP-product-listing {width:135px;}
	...
	<xsl:template name="ProductDetail" match="Product">
		...
		<td class="promoLP-product-listing">		
			...
			<a class="promoLP-button" href="javascript:void(0);" title="Add Item to List">
				...
				<img alt="Add to List" src="http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/Kelloggs/specialkq42012/Images/Button_AddToList.png" />
			</a>
		</td>
	</xsl:template>
