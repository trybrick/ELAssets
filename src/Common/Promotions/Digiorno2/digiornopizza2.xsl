...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<style>
			#promoLP-wrap {
				background: URL("http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/Digiorno/Images/Roundys_Digiorno_vFA2_Background.jpg"); height: 738px; width: 550px;
			}
			
			.learn { padding: 237px 191px 0;}
		...
		<div id="promoLP-wrap">
			<a href= "http://ad.doubleclick.net/clk;257775622;70975631;u?http://bricks.coupons.com/Bstart.asp?o=101990&amp;c=SR&amp;p=CEaA8Zki" target="_blank">
				<img class= "learn" src="http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/Digiorno/Images/GetCouponButton.png" alt= "Learn More"/>
			</a>
