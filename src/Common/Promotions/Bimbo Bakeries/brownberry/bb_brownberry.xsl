...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<div class="s-container">
			<img src="http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/bimbo bakeries/brownberry/images/brownberryheader.jpg" />
				<div class="facebook">
					<a href="https://www.facebook.com/BrownberryBread" target="_blank">
						<img src="http://upload.gsngrocers.com/elvs/Assets/Common/Promotions/bimbo bakeries/brownberry/images/fb_logo.png" alt= "facebook"/>
					</a>
				</div>
			<div class="items">
