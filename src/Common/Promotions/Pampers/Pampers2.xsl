...
<xsl:template match="/">
	<style>
		#promo-header h1 { background:transparent url('/Assets/Common/Promotions/Pampers/images/Nprd_thickcare_wipes_2.jpg') no-repeat left top scroll; height:102px; text-indent:-9999px; width:590px; }
	...
	<div id="promo-main">
		...
		<h2>Pampers ThickCare Wipes. Thick, strong and washcloth-like.</h2>
