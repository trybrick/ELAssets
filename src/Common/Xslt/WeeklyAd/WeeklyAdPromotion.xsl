...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:import href="WeeklyAdPagePromotion.xsl" />
	<xsl:output method="html" />
  
	<xsl:template match="/">
    <xsl:choose>
			<xsl:when test="count(ExpressLane/StoreCircular/Pages/StoreCircularPage) > 0">
				<div id="CircularAd">
					...
					<xsl:if test="ExpressLane/WeeklyAd/StoreCircular/Pages/StoreCircularPage/Items/StoreCircularItem">
						<div id="CircularLists">
							<select id="ddlDepartment" onchange="javascript:DisplayCircularItemsByCategoryID();">
								...
								<xsl:for-each select="ExpressLane/StoreCircular/Categories/Category">
					...
					<div id="CircularAdGrid">
						<xsl:if test="ExpressLane/StoreCircular/Pages/StoreCircularPage">
							<div>
								<ul id="CircularPagerTop" style="display:block;visibility:visible;">
									<xsl:for-each select="ExpressLane/StoreCircular/Pages/StoreCircularPage">
								...
								<div id="AdContent">
									<xsl:for-each select="ExpressLane/StoreCircular/Pages/StoreCircularPage[position() = 1]">
