...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<div id="SearchResultsHeader">
			...
			<p>These products are authorized for sale at your Metro Market store. It is possible that items on this list are currently out of season or out of stock.</p>
			<h4>
