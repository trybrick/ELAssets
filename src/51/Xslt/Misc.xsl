...
<xsl:template match="/">
    ...
    function showImage(page)
    {
		...
		<div id="StaticContentImg">
			<h3 id="recipeHeading" class="pageHeading">Spring and Summer Recipes</h3>
		<xsl:for-each select="ExpressLane/ArrayOfStaticContent/StaticContent">
				<a><xsl:attribute name="href">javascript:showImage(<xsl:value-of select="SortBy"/>);</xsl:attribute>
