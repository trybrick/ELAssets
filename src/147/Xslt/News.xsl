...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		    ...
		    function showImage(page)
		    {
				...
				<div id="EventsDiv" style="clear:both; width:100%; float:left; text-align:center">
					<xsl:choose>
						<xsl:when test="ExpressLane/ArrayOfStaticContent/StaticContent[1]/Image != ''">
							...
							<div id="staticImage" style="width:910px; text-align:center; float:left; margin:0 auto;">
						...
						<xsl:otherwise>
							<div id="noContent">
								<h2 style="border:none;">There is no content to display at this time. Please check again soon.</h2>
							</div>
						</xsl:otherwise>
					</xsl:choose>
				</div>	
