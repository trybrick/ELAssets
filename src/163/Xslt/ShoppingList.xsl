		...
		<div id="StoreHeaderRight">
			<xsl:choose>
				<xsl:when test="//GenericConsumer/IsLoggedIn = 'false'">
					...
					<br/>Please <a href="##root##/Profile/SignUp.aspx">Register</a> or <a href="##root##/Profile/SignIn.aspx">Sign In</a>
				</xsl:when>
				...
				<br/>
				<a href="##root##/Profile/Signup.aspx">Edit My Profile</a>| <a href="##root##/Profile/SignOut.aspx">Sign Out</a></xsl:when>
			</xsl:choose>
		</div>
		<div id="ShoppingList">
