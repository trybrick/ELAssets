...
<a href="https://reset-self-service.roundys.com/" target="_blank">
		...
		<div id="corpContent">
			...
			<a href="http://employeedocs.roundys.com/KrogerEUID" target="_blank"><img class="empl-shop" src="/Assets/225/Images/kroger_euid_retrieval_onerdybox.png" /></a>
		</div>
			...
			<div id="essMenu">
				<ul class="parent-menu">
					<li data-title="Dependents and Beneficiaries, Benefits Summary, Savings Contribution Summary, Insurance Summary, Benefits Enrollment" class="tooltip">
						<a href="https://employees.roundys.com/psp/pshrprd/EMPLOYEE/HRMS/s/WEBLIB_PTPP_SC.HOMEPAGE.FieldFormula.IScript_AppHP?pt_fname=HC_BENEFITS_ESS&amp;FolderPath=PORTAL_ROOT_OBJECT.CO_EMPLOYEE_SELF_SERVICE.HC_BENEFITS_ESS&amp;IsFolder=true"><span>Benefits</span></a>
					</li>
					<li data-title="New Hire &amp; Annual Open Enrollment Elections" class="tooltip">
						<a href="https://employees.roundys.com/psp/pshrprd/EMPLOYEE/HRMS/c/W3EB_MENU.W3EB_ENR_SELECT.GBL?NAVSTACK=Clear&amp;PORTALPARAM_PTCNAV=HC_W3EB_ENR_SELECT_GBL&amp;EOPP.SCNode=HRMS&amp;EOPP.SCPortal=EMPLOYEE&amp;EOPP.SCName=HC_BENEFITS_ESS&amp;EOPP.SCLabel=Benefits&amp;EOPP.SCPTfname=HC_BENEFITS_ESS&amp;FolderPath=PORTAL_ROOT_OBJECT.CO_EMPLOYEE_SELF_SERVICE.HC_BENEFITS_ESS.HC_W3EB_ENR_SELECT_GBL&amp;IsFolder=false"><span>Benefits Enrollment</span></a>
					</li>
					...
					<li data-title="Submit and review leave information" class="tooltip">
						<a href="https://idm.roundys.com/idp/profile/SAML2/Unsolicited/SSO?providerId=ReedGroup&amp;target=https://roundysloa.reediam.com/router.ashx?cmd=sso"><span>Leave Management</span></a>
					</li>
					...
					<li data-title="Home and Mailing Address, Personal Information Summary, Phone Numbers, Email Address, Emergency Contacts, Roundy’s Reward Card" class="tooltip">
						<a href="https://employees.roundys.com/psp/pshrprd/EMPLOYEE/HRMS/s/WEBLIB_PTPP_SC.HOMEPAGE.FieldFormula.IScript_AppHP?pt_fname=HC_PERSONAL_INFO_ESS&amp;FolderPath=PORTAL_ROOT_OBJECT.CO_EMPLOYEE_SELF_SERVICE.HC_PERSONAL_INFO_ESS&amp;IsFolder=true"><span>Personal Information</span></a>
					</li>
					...
					<li data-title="Voluntary Benefits Enrollment" class="tooltip">
						<a href="https://idm.roundys.com/idp/profile/SAML2/Unsolicited/SSO?providerId=https://www.benedetails.com"><span>Voluntary Benefits Enrollment</span></a>
					</li>
