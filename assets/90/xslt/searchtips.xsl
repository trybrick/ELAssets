...
<div id="SearchTips">
	...
	<div id="SearchTipsContent">
		...
		<div class="SearchTipsSubject" id="div2" style="display:none;">
			...
			<p>Once you've signed in there are several easy ways to find a product:
						</p>
						<ul>
							<li>
							...
							<li><p><strong>Select the &quot;Saved
			Carts&quot;</strong> tab in which grocery items can be added/subtracted or viewed in your saved shopping list/cart.</p> 
							</li>
							<li>
								<p><strong>Select the &quot;Things I Buy&quot;</strong> tab to view items that you have previously purchased and quickly add them to your cart.</p>
							</li>
						</ul>
		</div>
		...
		<div class="SearchTipsSubject" id="div4" style="display:none;">
			...
			<li><strong>Verify</strong> your correct delivery address.</li> <li><strong>Select</strong> &quot;Delivery/Pickup Options:&quot; and &quot;Substitution Preferences&quot;.</li> <li><strong>Review</strong> your &quot;Order Confirmation&quot; and cart total.</li> 
			<li><strong>Enter</strong> payment (Visa, Master Card, Discover, American Express or JCB), billing and shipping information.
			</li> 
			<li><strong>Click</strong> on the &quot;Submit&quot; button to place your order.</li></ol>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\Xml\AboutUs.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
