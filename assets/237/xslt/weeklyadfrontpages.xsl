...
<!--========================================================================================== -->
	...
	<xsl:template match="/">
		...
		<div style="font-family:Arial;font-size:9pt;margin-bottom:-15px;"> 
			Currently advertised sale prices are in effect Sunday thru Saturday. <br/> 
			Items are priced based on current price on date order is picked up or delivered. 
		</div>
