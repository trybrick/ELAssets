...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:import href="/Assets/Common/Xslt/Google/SiteSearchControl.xsl" />
	...
	<xsl:template match="/">
		...
		<div id="StoreHeader">
			<a id="StoreHeaderLogo" href="{//GenericChain/PreferedHost}">
			...
			<div id="StoreHeaderLoginContainer">			
				<xsl:apply-imports/>
				<xsl:call-template name="GoogleSiteSearch" />
			</div>
