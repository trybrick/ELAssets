	...
	<xsl:template match="/">
		...
		<xsl:for-each select="ExpressLane/RecipeData/GenericRecipe">
			<div class="hrecipe group">
				...
				<div id="recipetitle">
					<h2 class="fn"><xsl:value-of select="Title"/></h2>
				</div>
				<div id="reciperating">
				...
				<div id="recipeoptions">
					...
					<ul>
						<li class="recipesave">
							<a id="recipesave" href="javascript:void(0);" title="Save to my recipe box">
						...
						<li class="recipeprint">
							<a id="recipeprint" title="Print this recipe" href="javascript:void(0);" onclick="window.print();">Print Recipe</a>
						</li>
						<li class="recipeaddchecked">
							<a id="recipeaddchecked" href="javascript:void(0);" onclick="AddRecipeCheckedItemsToShoppingList();" title="Add selected items to your list">Add Checked to
								<xsl:choose>
						...
						<li class="recipeaddall">
							<a id="recipeaddall" title="Add all ingredients to your list">
							...
							<div class="circularHoversNew">
								<div class="circularHoversImage">
									<xsl:if test="SmallImageUrl">
										<img alt="{CircularItemName}" src="{SmallImageUrl}" />
									</xsl:if>
								</div>
				...
				<xsl:variable name="isShowNutrient" select="../../GenericChain/ChainSettings/Setting[SettingID = 172]/Value"/>
				
				<xsl:if test="Nutrients/GenericNutrient and $isShowNutrient != 'false'">
