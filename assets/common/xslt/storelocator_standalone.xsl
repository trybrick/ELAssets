...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	<xsl:template match="/" name="StoreLocator_Standalone">
		...
		<script type="text/javascript">
			...
			function getStoreHTML(store, storeListing) {
				...
				var tmpHTML= $(store.GridElement).innerHTML;
		...
		<div id="StoreLocator">
			...
			**************************************************************-->
			...
			<a class="button go"><span>Go</span></a>
			<div id="StoreLocatorZipLookup">
				...
				<div id="storeZipEntryForm">
					...
					<div class="map-button-group">
						...
						<a class="button" href="/StoreLocator.aspx">
